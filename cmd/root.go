...
func init() {
	...
	mergeCmd.Flags().BoolVar(&mergeFlagAllowMultiMerge, "allow-multi-merge", false, "Allow large number of simultaneous merges")
	...
	pushCmd.Flags().BoolVar(&pushFlagAllowMultiPush, "allow-multi-push", false, "Allow large number of simultaneous pushes")
